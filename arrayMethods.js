...
const sixteenCenturyInventors = inventors.filter((inventor) => {
  return inventor.year >= 1500 && inventor.year <1600;
})

console.log(sixteenCenturyInventors)
...
const birthYearsInventors = inventors.map((inventor) => {
  return inventor.year
})

console.log(birthYearsInventors)
...
// ]
inventors.sort((a,  b) => {
  const yearLivedA = a.passed - a.year;
const yearLivedB = b.passed - b.year;
return yearLivedB -yearLivedA
})
 console.log(inventors)
